...
class QLearningTable:
    def __init__(self, actions, learning_rate=0.01, reward_decay=0.9, e_greedy=0.9):
        ...
        self.q_table = pd.read_pickle('sparse_agent_data')
    ...
    def print_q_table(self, s, a):
        ...
        q_predict = self.q_table.ix[s, a]
        print('action : ',a,' q_value : ',q_predict)
...
class MoveToBeacon(base_agent.BaseAgent):
    ...
    def step(self, obs):
            ...
            if self.previous_reward == obs.observation["score_cumulative"][0] and self.previous_action is not None and self.destination_reached:
            ...
            rl_action = self.qlearn.choose_action(str(current_state)) #we let the q-table decide of the next action and add the state if it doesn't exist
